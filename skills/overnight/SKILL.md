...
(`<plan><review_suffix>`, default `.review.md`) says `VERDICT: APPROVED`, bound to the plan by
name -- what the user approved is what counts; the plan has a `## Overnight policy`
